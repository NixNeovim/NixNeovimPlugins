{
  ...
  */
  rooter-nvim = buildVimPlugin {
    ...
    version = "2025-03-23";
    src = fetchurl {
      url = "https://github.com/wsdjeg/rooter.nvim/archive/cc28b83fc49189ddb8ea45548591ec0d51f5a3ae.tar.gz";
      sha256 = "08im7zmvy4q41j32f54ijsbh5vsplrk4gidr1cgkpza3xqw7jcp7";
    };
    meta = with lib; {
