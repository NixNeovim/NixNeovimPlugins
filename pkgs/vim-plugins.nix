{
  ...
  */
  fzf-lua = buildVimPlugin {
    ...
    version = "2025-03-27";
    src = fetchurl {
      url = "https://github.com/ibhagwan/fzf-lua/archive/1dcef2467af609e0688f8136b8ea720645c9c41c.tar.gz";
      sha256 = "0zpxda5j95c6pl1kn03q2r1cik5v1y5li3fv7s03hzk86vkj6wv3";
    };
    meta = with lib; {
