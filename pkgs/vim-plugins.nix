{
  ...
  */
  neominimap-nvim-Isrothy = buildVimPlugin {
    ...
    version = "2026-03-31";
    src = fetchurl {
      url = "https://github.com/Isrothy/neominimap.nvim/archive/b0fffd0cfbf9c249bc0f08922993579f143a750d.tar.gz";
      sha256 = "19w7pik0jjwd75f6fqah2hrg0iqbcsid68pz1zih3px42xn898d0";
    };
    meta = with lib; {
