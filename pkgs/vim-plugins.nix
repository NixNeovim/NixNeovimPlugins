{
  ...
  */
  haskell-tools-nvim = buildVimPlugin {
    ...
    version = "2024-06-23";
    src = fetchurl {
      url = "https://github.com/MrcJkb/haskell-tools.nvim/archive/1e66a1919666bc2d4dc3df6d02ae4ef1c4592162.tar.gz";
      sha256 = "0ig6605fz29aa1s9znhmc4hs6klpq0kzsh96cib62r0glj71mj76";
    };
    meta = with lib; {
