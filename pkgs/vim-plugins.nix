...

{
  ...
  treesj = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-03";
    src = fetchurl {
      url = "https://github.com/Wansmer/treesj/archive/f487c9117c79b118ab792ffdd12125626c63b281.tar.gz";
      sha256 = "0mi8hwfp72ba0q5l2mqrlk62rds8k70h9kl3zn8zh1wr9vy50gy5";
    };
    meta = with lib; {
