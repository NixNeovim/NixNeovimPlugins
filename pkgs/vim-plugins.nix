{
  ...
  */
  obsidian-nvim = buildVimPlugin {
    ...
    version = "2025-05-06";
    src = fetchurl {
      url = "https://github.com/obsidian-nvim/obsidian.nvim/archive/240c8041d41f6a884800e27e5efc3cd95d569b93.tar.gz";
      sha256 = "0xc1qshq9f6s92nwfwyxpa4j0a7rnpys0x64cwrarp43cbvg3qfg";
    };
    meta = with lib; {
