{
  ...
  */
  neominimap-nvim-Isrothy = buildVimPlugin {
    ...
    version = "2026-04-12";
    src = fetchurl {
      url = "https://github.com/Isrothy/neominimap.nvim/archive/0676085d898019f06044923934e38663f5efa290.tar.gz";
      sha256 = "0syb036h2cp2k0mzybqd4hnxnr43mcsh727wi1hfqrz5cnwfdbxb";
    };
    meta = with lib; {
