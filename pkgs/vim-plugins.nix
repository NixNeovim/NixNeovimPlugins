...

{
  ...
  hlchunk-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-11";
    src = fetchurl {
      url = "https://github.com/shellRaining/hlchunk.nvim/archive/523c1d5bb9ed4687c3d3a630db08f068e37ae2a1.tar.gz";
      sha256 = "0qh2bn3wwas32m9ssnhyx1fwbv36c058yk46jikp05hgbnxpgckd";
    };
    meta = with lib; {
  ...
  harpoon = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-10";
    src = fetchurl {
      url = "https://github.com/ThePrimeagen/harpoon/archive/3476228be2d79f66ebbdb34eafc45842d054f7df.tar.gz";
      sha256 = "1vy6d6w3nwzchbd1m23kg4diwjpayab4xhvmar8150pz2z44aczl";
    };
    meta = with lib; {
  ...
  neotest = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-11";
    src = fetchurl {
      url = "https://github.com/nvim-neotest/neotest/archive/35aa5832e35129c00c48eb7d5862b44745392f69.tar.gz";
      sha256 = "0xg12br0813qvdzpf4nvhbirm0zm8imbvhmr23k1a3l1xky63dwq";
    };
    meta = with lib; {
  ...
  neorg = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-10";
    src = fetchurl {
      url = "https://github.com/nvim-neorg/neorg/archive/cc2834ae2beb2d5baa75d15848a94dae022faa2c.tar.gz";
      sha256 = "1cs11swvakkg60z03mviiysffqcdm03lhhl56vg0wr5sff2lwjps";
    };
    meta = with lib; {
  ...
  octo-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-11";
    src = fetchurl {
      url = "https://github.com/pwntester/octo.nvim/archive/ec9ac06eebd45bdbdfaa0c3c0067d5c230e4c1ff.tar.gz";
      sha256 = "13yc8yva4mfi5azsr5h6975cmmf470r390fk14281i2swxj8686f";
    };
    meta = with lib; {
  ...
  git-blame-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-10";
    src = fetchurl {
      url = "https://github.com/f-person/git-blame.nvim/archive/37abc3436aef9b9fe37f38541fe096f8a42b8d4a.tar.gz";
      sha256 = "1frf8d3grj6rh8dngfvj2z4s0ngivniy1ppifbbzhgr13q8i7mmp";
    };
    meta = with lib; {
  ...
  flutter-tools-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-10";
    src = fetchurl {
      url = "https://github.com/akinsho/flutter-tools.nvim/archive/677e3837a8ea2645362d08f48279b7284117f9a0.tar.gz";
      sha256 = "1fx3dxb6rkkp1lifks70f6hvl1bwlpdz9kjpjljglckmsw9sah18";
    };
    meta = with lib; {
  ...
  github-colors = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-08";
    src = fetchurl {
      url = "https://github.com/lourenci/github-colors/archive/9a73695bf7b0b68e7c4f80d924ed0ef0446f0b74.tar.gz";
      sha256 = "0gzmlrx2ix6lap8nrpdb160glpc4nzaq5f834qccy3g28ws41c6s";
    };
    meta = with lib; {
  ...
  coq-artifacts = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-07";
    src = fetchurl {
      url = "https://github.com/ms-jpq/coq.artifacts/archive/6e15912d7cb19c4c0f5d947b8d95bb54099a1dfb.tar.gz";
      sha256 = "0dnzyy2i03bk4dm4j05cr5wk2kg5g0dh2rhqj1yc979srljg3yv7";
    };
    meta = with lib; {
      description = "No description";
  ...
  nlsp-settings-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-11";
    src = fetchurl {
      url = "https://github.com/tamago324/nlsp-settings.nvim/archive/d918d016824b579331acda117166112bc142e70a.tar.gz";
      sha256 = "01civj1c97xp5sv808x40jy26c1j0pd3gd1iif1pgsgw6m4fr6a0";
    };
    meta = with lib; {
  ...
  SchemaStore-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-10";
    src = fetchurl {
      url = "https://github.com/b0o/SchemaStore.nvim/archive/301471a8611494ceb7255003bc9d3c6fb8584009.tar.gz";
      sha256 = "099mbwdq74n3q1fqjrpsqzhmqxdxiff9bbw97lq6yivdrlhqpg5n";
    };
    meta = with lib; {
  ...
  fzf-lua = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-07";
    src = fetchurl {
      url = "https://github.com/ibhagwan/fzf-lua/archive/4cd83bf754d5bf786a0835511f65643d7b925a55.tar.gz";
      sha256 = "1rar5rkh3vwk2imwqyxr36gj2i2xa1zbb5lniw4vwx41fkwklycw";
    };
    meta = with lib; {
  ...
  nap-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-09";
    src = fetchurl {
      url = "https://github.com/liangxianzhe/nap.nvim/archive/ba2cbd9e120a940ece87f50cc98d12b17fc12449.tar.gz";
      sha256 = "12kg138h5qac3mi3vgska47088pdj0wiy2baglgcwcichi4rv4by";
    };
    meta = with lib; {
  ...
  mini-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-11";
    src = fetchurl {
      url = "https://github.com/echasnovski/mini.nvim/archive/c5013d1eb698638308029b4301806f1a5a483f11.tar.gz";
      sha256 = "0r8vjrvpfhgw6rnalv3rpglsl2fv5m51lhh1zi8y9d0idmyainqk";
    };
    meta = with lib; {
  ...
  null-ls-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-10";
    src = fetchurl {
      url = "https://github.com/jose-elias-alvarez/null-ls.nvim/archive/08bb00c7c2cd58c72e02cf54e4b9cbfe14b03e09.tar.gz";
      sha256 = "0cjbv8w7w5widnv8pzagc5a8q8nc5vx6lk8pvh7ln2ngsk5xipmk";
    };
    meta = with lib; {
  ...
  nvim-navbuddy = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-09";
    src = fetchurl {
      url = "https://github.com/SmiteshP/nvim-navbuddy/archive/923cf51fb852c062c63c7ade236a4938f1081d5b.tar.gz";
      sha256 = "0grp10a2125vgbdayn6wjpsrwab8d4rm8091hh200s9gc7j9gpwl";
    };
    meta = with lib; {
  ...
  bufferline-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-09";
    src = fetchurl {
      url = "https://github.com/akinsho/bufferline.nvim/archive/018bdf61a97e00caeff05d16977437c63018762e.tar.gz";
      sha256 = "07jygkk6d7dgax4y8n46pxjiw550nfxfkn6yr2ksngszw4jsf46l";
    };
    meta = with lib; {
  ...
  nvim-lspconfig = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-11";
    src = fetchurl {
      url = "https://github.com/neovim/nvim-lspconfig/archive/1c0e6d39aa93deebdee35d4945889641e764619e.tar.gz";
      sha256 = "1vv5nx8vrwsjg9r04gw800ahifhs9xrmh3c3gspxq6zhjbw06fkm";
    };
    meta = with lib; {
  ...
  sfm-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-08";
    src = fetchurl {
      url = "https://github.com/dinhhuy258/sfm.nvim/archive/762ee1f1ec64f50cc2a02416dad36bc5ccf8d60c.tar.gz";
      sha256 = "1plsdq69xdhlk6pmlh6sfcl0xs48kxz2q4zhdlb1l8dcgl7krssj";
    };
    meta = with lib; {
  ...
  copilot-cmp = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-10";
    src = fetchurl {
      url = "https://github.com/zbirenbaum/copilot-cmp/archive/dd2c72d2c6eafe2b91198e4b1ce6171df7b58606.tar.gz";
      sha256 = "0pi8h3x740lbhkpmhw8h6cwf81243dgyzfr1j8px3kmmhvg9kbpj";
    };
    meta = with lib; {
  ...
  ultimate-autopair-nvim = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-11";
    src = fetchurl {
      url = "https://github.com/altermo/ultimate-autopair.nvim/archive/25d63719434b31b64f971dbf1fb12cf1c19d3faa.tar.gz";
      sha256 = "1ki0vy7ik7ggcg0w1gw6yyg1dm3xz23jiciaqq584hz75xksq0y3";
    };
    meta = with lib; {
  ...
  vim-workspace = buildVimPluginFrom2Nix {
    ...
    version = "2023-05-10";
    src = fetchurl {
      url = "https://github.com/thaerkh/vim-workspace/archive/a9ae9ce1f8ec59d1a6ed847ce6c5b994a40f0a8b.tar.gz";
      sha256 = "1v2sj10mkhrlk7d79zbdib6idzah1x1d1apcvkzzcvjryyj2fjwv";
    };
    meta = with lib; {
