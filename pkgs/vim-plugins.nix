...

{
  ...
  null-ls-nvim = buildVimPlugin {
    ...
    version = "2021-12-11";
    src = fetchurl {
      url = "https://github.com/jose-elias-alvarez/null-ls.nvim/archive/385f3177a199e98e2f527b4de44eb955563eff96.tar.gz";
      sha256 = "08iwhg149x065izhl47jjcw4q7ykiqqzddvxzljgh7llkhnmf09c";
    };
  };
