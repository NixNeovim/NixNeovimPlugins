...
known_issues=$(gh api -H "Accept: application/vnd.github+json" /repos/Blackhole1504/NixNeovimPlugins/issues?labels=bot | jq -r ".[].body")
        ...
        do
            ...
            then
                ...
                curl \
                    ...
                    https://api.github.com/repos/Blackhole1504/NixNeovimPlugins/issues \
